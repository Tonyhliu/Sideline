...
guest_user = User.create(username: "DemoUser",
                          password: "Password",
                          avatar_url: );
comment_user = User.create(username: "TonyDaTiger",
                          password: "password",
                          avatar_url: "http://res.cloudinary.com/dcbb8bnvk/image/upload/w_400,h_400,c_crop,g_face,r_max/w_200/IMG_6184_ffefob.png";);
comment_user2 = User.create(username: "Alexandra",
                            password: "password",
                            avatar_url:);
comment_user3 = User.create(username: "DaRealKushPatel",
                            password: "password",
                            avatar_url: "http://res.cloudinary.com/dcbb8bnvk/image/upload/w_400,h_400,c_crop,g_face,r_max/w_200/kush_xuj00h.png");
comment_user4 = User.create(username: "",
                            password: "password",
                            avatar_url: );
comment_user5 = User.create(username: "KentheTA",
                            password: "password",
                            avatar_url:);
comment_user6 = User.create(username: "GagetheTA",
                            password: "password",
                            avatar_url:);
comment_user7 = User.create(username: "StephCurry",
                            password: "password",
                            avatar_url:);
...
http://res.cloudinary.com/dcbb8bnvk/image/upload/w_400,h_400,c_crop,g_face,r_max/w_200/profilepic_cty3ak.png
